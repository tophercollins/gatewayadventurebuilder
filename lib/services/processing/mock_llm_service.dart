...
class MockLLMService implements LLMService {
  ...
  Future<LLMResult<SummaryResponse>> generateSummary({
    ...
    return const LLMResult.success(
      SummaryResponse(
        overallSummary:
            '''The party gathered at the Rusty Tankard tavern to '''
      ...
      ScenesResponse(
        scenes: [
          SceneData(
            ...
            summary:
                'The party met at the Rusty Tankard to plan their expedition.',
            startTimeMs: 0,
            endTimeMs: 1800000,
          ),
          SceneData(
          ...
          SceneData(
            ...
            summary:
                'Freed a captured merchant who provided quest information.',
            startTimeMs: 7200000,
            endTimeMs: 9000000,
          ),
          SceneData(
