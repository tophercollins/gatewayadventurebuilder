...
class _WorldsContent extends StatelessWidget {
...
class _WorldCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Navigate to the first campaign's world database if available.
    VoidCallback? onTap;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Worlds are created automatically when you start a campaign',
